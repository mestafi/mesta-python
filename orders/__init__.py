...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CreateV1OrdersResponse": ".types",
    "CreateV1OrdersResponseData": ".types",
    "CreateV1OrdersResponseDataStatus": ".types",
    "CreateV2OrdersResponse": ".types",
    "CreateV2OrdersResponseData": ".types",
