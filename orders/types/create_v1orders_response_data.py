...
class CreateV1OrdersResponseData(UniversalBaseModel):
    ...
    status: typing.Optional[CreateV1OrdersResponseDataStatus] = pydantic.Field(default=None)
    """
    ...
    awaiting_funds_expires_at: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="awaitingFundsExpiresAt",
            description="Timestamp when the awaiting funds status expires (30 minutes from creation)",
        ),
    ] = None
    """
