...
class CreateSendersResponseDataDocumentsItem(UniversalBaseModel):
    ...
    type: typing.Optional[CreateSendersResponseDataDocumentsItemType] = pydantic.Field(default=None)
    """
    Type of document
    """
