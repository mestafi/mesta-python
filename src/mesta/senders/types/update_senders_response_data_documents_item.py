...
class UpdateSendersResponseDataDocumentsItem(UniversalBaseModel):
    ...
    type: typing.Optional[UpdateSendersResponseDataDocumentsItemType] = pydantic.Field(default=None)
    """
    Type of document
    """
