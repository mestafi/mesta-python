...
class ListSendersResponse(UniversalBaseModel):
    data: typing.Optional[typing.List[ListSendersResponseDataItem]] = pydantic.Field(default=None)
    """
    List of senders
    """
    ...
    has_next: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="hasNext", description="Indicates if there are more senders available for pagination"),
    ] = None
    """
