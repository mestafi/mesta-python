...
class GetSendersResponseDataTos(UniversalBaseModel):
    """
    Terms of Service status for the sender
    """

    status: typing.Optional[GetSendersResponseDataTosStatus] = pydantic.Field(default=None)
    """
    ...
    link: typing.Optional[GetSendersResponseDataTosLink] = pydantic.Field(default=None)
    """
