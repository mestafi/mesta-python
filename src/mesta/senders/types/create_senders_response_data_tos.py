...
class CreateSendersResponseDataTos(UniversalBaseModel):
    """
    Terms of Service status for the sender
    """

    status: typing.Optional[CreateSendersResponseDataTosStatus] = pydantic.Field(default=None)
    """
    ...
    link: typing.Optional[CreateSendersResponseDataTosLink] = pydantic.Field(default=None)
    """
