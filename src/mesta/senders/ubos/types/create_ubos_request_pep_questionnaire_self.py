...
from .create_ubos_request_pep_questionnaire_self_pep_category import CreateUbosRequestPepQuestionnaireSelfPepCategory


class CreateUbosRequestPepQuestionnaireSelf(UniversalBaseModel):
    """
