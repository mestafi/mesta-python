...
from .update_ubos_response_data_pep_questionnaire_association import UpdateUbosResponseDataPepQuestionnaireAssociation
...
class UpdateUbosResponseDataPepQuestionnaire(UniversalBaseModel):
    """
    ...
    declaration_type: typing_extensions.Annotated[
        typing.Optional[UpdateUbosResponseDataPepQuestionnaireDeclarationType],
    ...
    self_: typing_extensions.Annotated[
        typing.Optional[UpdateUbosResponseDataPepQuestionnaireSelf],
    ...
    association: typing.Optional[UpdateUbosResponseDataPepQuestionnaireAssociation] = pydantic.Field(default=None)
    """
