...
class CreateUbosRequestIdentity(UniversalBaseModel):
    """
    Identity information for the UBO.
    """

    document_type: typing_extensions.Annotated[
        CreateUbosRequestIdentityDocumentType, FieldMetadata(alias="documentType"), pydantic.Field(alias="documentType")
    ]
