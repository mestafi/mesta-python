...
class ListOrdersResponse(UniversalBaseModel):
    data: typing.Optional[typing.List[ListOrdersResponseDataItem]] = pydantic.Field(default=None)
    """
    List of orders
    """
    ...
    has_next: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="hasNext", description="Indicates if there are more orders available for pagination"),
    ] = None
    """
