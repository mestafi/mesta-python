...
class CreateWebhooksResponseData(UniversalBaseModel):
    ...
    events: typing.Optional[typing.List[CreateWebhooksResponseDataEventsItem]] = pydantic.Field(default=None)
    """
