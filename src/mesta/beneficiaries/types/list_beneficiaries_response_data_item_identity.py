...
class ListBeneficiariesResponseDataItemIdentity(UniversalBaseModel):
    """
    Identity document information
    """

    document_type: typing_extensions.Annotated[
        typing.Optional[ListBeneficiariesResponseDataItemIdentityDocumentType],
    ...
    front: typing.Optional[ListBeneficiariesResponseDataItemIdentityFront] = pydantic.Field(default=None)
    """
