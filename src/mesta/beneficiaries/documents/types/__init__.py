...
if typing.TYPE_CHECKING:
    ...
    from .get_purpose_of_payment_presigned_url_documents_response import (
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "GetPresignedUrlDocumentsResponseDataType": ".get_presigned_url_documents_response_data_type",
    "GetPurposeOfPaymentPresignedUrlDocumentsResponse": ".get_purpose_of_payment_presigned_url_documents_response",
}
