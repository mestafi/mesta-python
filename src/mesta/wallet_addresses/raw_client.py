...
class RawWalletAddressesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def get(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetWalletAddressesResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/source-wallet-addresses/{encode_path_param(id)}",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetWalletAddressesResponse,  # type: ignore
...
class AsyncRawWalletAddressesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetWalletAddressesResponse]:
        """
        Retrieves a single source wallet address by its unique identifier.
