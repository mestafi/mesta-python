...
from ....types.stablecoin_deposit import StablecoinDeposit


class ListStablecoinDepositsResponse(UniversalBaseModel):
    data: typing.Optional[typing.List[StablecoinDeposit]] = None
