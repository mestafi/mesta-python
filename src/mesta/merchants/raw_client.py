...
class RawMerchantsClient:
    ...
    def get(
    ...
    ) -> HttpResponse[GetMerchantsResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/merchants/{encode_path_param(merchant_id)}",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetMerchantsResponse,  # type: ignore
    ...
    def accept_terms(
        self, merchant_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[AcceptTermsMerchantsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/merchants/{encode_path_param(merchant_id)}/accept-terms",
            method="POST",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AcceptTermsMerchantsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_balances(
        self, merchant_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetBalancesMerchantsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/merchants/{encode_path_param(merchant_id)}/balances",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GetBalancesMerchantsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawMerchantsClient:
    ...
    async def get(
        self, merchant_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetMerchantsResponse]:
        """
        Retrieves detailed information about a specific merchant, including account details and UBO (Ultimate Beneficial Owner) information.
    ...
    async def accept_terms(
        self, merchant_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AcceptTermsMerchantsResponse]:
        """
        Records the merchant's acceptance of Terms of Service. Captures acceptance timestamp, user identity, and IP address.
    ...
    async def get_balances(
        self, merchant_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetBalancesMerchantsResponse]:
        """
        Retrieves the current balances for a merchant across all currencies and stablecoins.
