...
class RawSourceWalletAddressesClient:
    ...
    def list(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/merchants/{encode_path_param(merchant_id)}/source-wallet-addresses",
            method="GET",
    ...
    def delete(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/merchants/{encode_path_param(merchant_id)}/source-wallet-addresses/{encode_path_param(source_wallet_address_id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
