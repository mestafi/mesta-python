...
class GetBeneficiariesResponseData(UniversalBaseModel):
    ...
    owner: typing.Optional[GetBeneficiariesResponseDataOwner] = pydantic.Field(default=None)
    """
    Type of entity these rules apply to
    """

    owner_type: typing_extensions.Annotated[
        typing.Optional[GetBeneficiariesResponseDataOwnerType],
    ...
    rules: typing.Optional[GetBeneficiariesResponseDataRules] = None
...
update_forward_refs(GetBeneficiariesResponseData)
