...
class ListPaymentTypesBeneficiariesResponseData(UniversalBaseModel):
    ...
    created_at: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="createdAt", description="Timestamp when the rules were created (ISO 8601)"),
    ] = None
    """
    ...
    updated_at: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="updatedAt", description="Timestamp when the rules were last updated (ISO 8601)"),
    ] = None
    """
    ...
    deleted_at: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="deletedAt", description="Timestamp when the rules were deleted, if applicable (ISO 8601)"
        ),
    ] = None
    """
    ...
    owner: typing.Optional[ListPaymentTypesBeneficiariesResponseDataOwner] = pydantic.Field(default=None)
    """
    Type of entity these rules apply to
    """

    owner_type: typing_extensions.Annotated[
        typing.Optional[ListPaymentTypesBeneficiariesResponseDataOwnerType],
        FieldMetadata(alias="ownerType"),
        pydantic.Field(alias="ownerType", description="Category of the beneficiary"),
    ] = None
    """
    ...
    rules: typing.Optional[ListPaymentTypesBeneficiariesResponseDataRules] = None
...
update_forward_refs(ListPaymentTypesBeneficiariesResponseData)
