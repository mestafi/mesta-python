...
class GetQuotesResponseData(UniversalBaseModel):
    ...
    transfer_type: typing_extensions.Annotated[
        typing.Optional[GetQuotesResponseDataTransferType],
    ...
    status: typing.Optional[GetQuotesResponseDataStatus] = pydantic.Field(default=None)
    """
