...
class ListQuotesResponseDataItem(UniversalBaseModel):
    ...
    transfer_type: typing_extensions.Annotated[
        typing.Optional[ListQuotesResponseDataItemTransferType],
    ...
    status: typing.Optional[ListQuotesResponseDataItemStatus] = pydantic.Field(default=None)
    """
