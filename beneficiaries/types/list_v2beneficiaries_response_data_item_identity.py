...
class ListV2BeneficiariesResponseDataItemIdentity(UniversalBaseModel):
    """
    Identity document information
    """

    document_type: typing_extensions.Annotated[
        typing.Optional[ListV2BeneficiariesResponseDataItemIdentityDocumentType],
    ...
    front: typing.Optional[ListV2BeneficiariesResponseDataItemIdentityFront] = pydantic.Field(default=None)
    """
