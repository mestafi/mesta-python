...
class CreateV3BeneficiariesResponseData(UniversalBaseModel):
    id: typing.Optional[str] = pydantic.Field(default=None)
    """
    Unique identifier for the beneficiary
    """

    type: typing.Optional[CreateV3BeneficiariesResponseDataType] = pydantic.Field(default=None)
    """
    Type of beneficiary
    """
    ...
    address: typing.Optional[CreateV3BeneficiariesResponseDataAddress] = None
    ...
    verification: typing.Optional[CreateV3BeneficiariesResponseDataVerification] = None
    status: typing.Optional[CreateV3BeneficiariesResponseDataStatus] = pydantic.Field(default=None)
    """
    Whether the beneficiary is active or inactive
    """

    identity: typing.Optional[CreateV3BeneficiariesResponseDataIdentity] = pydantic.Field(default=None)
    """
    Identity document information
    """

    business_type: typing_extensions.Annotated[
        typing.Optional[CreateV3BeneficiariesResponseDataBusinessType],
