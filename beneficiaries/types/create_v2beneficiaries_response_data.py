...
class CreateV2BeneficiariesResponseData(UniversalBaseModel):
    id: typing.Optional[str] = pydantic.Field(default=None)
    """
    Unique identifier for the beneficiary
    """

    type: typing.Optional[CreateV2BeneficiariesResponseDataType] = pydantic.Field(default=None)
    """
    Type of beneficiary
    """
    ...
    address: typing.Optional[CreateV2BeneficiariesResponseDataAddress] = None
    ...
    verification: typing.Optional[CreateV2BeneficiariesResponseDataVerification] = None
    status: typing.Optional[CreateV2BeneficiariesResponseDataStatus] = pydantic.Field(default=None)
    """
    Whether the beneficiary is active or inactive
    """

    identity: typing.Optional[CreateV2BeneficiariesResponseDataIdentity] = pydantic.Field(default=None)
    """
    Identity document information
    """

    business_type: typing_extensions.Annotated[
        typing.Optional[CreateV2BeneficiariesResponseDataBusinessType],
