...
from .get_v1beneficiaries_response_data_identity_document_type import GetV1BeneficiariesResponseDataIdentityDocumentType
from .get_v1beneficiaries_response_data_identity_front import GetV1BeneficiariesResponseDataIdentityFront


class GetV1BeneficiariesResponseDataIdentity(UniversalBaseModel):
    """
    Identity document information (required for certain countries)
    """

    document_type: typing_extensions.Annotated[
        typing.Optional[GetV1BeneficiariesResponseDataIdentityDocumentType],
    ...
    front: typing.Optional[GetV1BeneficiariesResponseDataIdentityFront] = pydantic.Field(default=None)
    """
