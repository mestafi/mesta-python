...
from mesta.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from mesta.core.request_options import RequestOptions
...
@patch("mesta.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("mesta.core.http_client.asyncio.sleep", new_callable=AsyncMock)
