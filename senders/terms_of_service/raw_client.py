...
class RawTermsOfServiceClient:
    ...
    def create_link(
        ...
        *,
    ...
    ) -> HttpResponse[CreateLinkTermsOfServiceResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/senders/{encode_path_param(id)}/tos-link",
            method="POST",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateLinkTermsOfServiceResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def accept(
        self, token: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[AcceptTermsOfServiceResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/senders/tos-acceptance/{encode_path_param(token)}/accept",
            method="POST",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AcceptTermsOfServiceResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawTermsOfServiceClient:
    ...
    async def create_link(
        ...
        *,
        regenerate: typing.Optional[bool] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateLinkTermsOfServiceResponse]:
        """
        Generates a Terms of Service acceptance link for a sender. If a valid link already exists and regenerate is not set to true, returns the existing link.
    ...
    async def accept(
        self, token: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AcceptTermsOfServiceResponse]:
        """
        Accepts the Terms of Service on behalf of a sender using the provided token. This is a public endpoint that does not require authentication. The client's IP address and user agent are recorded automatically.
