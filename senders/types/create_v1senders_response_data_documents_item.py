...
class CreateV1SendersResponseDataDocumentsItem(UniversalBaseModel):
    ...
    type: typing.Optional[CreateV1SendersResponseDataDocumentsItemType] = pydantic.Field(default=None)
    """
    Type of document
    """
