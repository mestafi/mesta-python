...
class CreateV2SendersResponseData(UniversalBaseModel):
    ...
    gender: typing.Optional[CreateV2SendersResponseDataGender] = pydantic.Field(default=None)
    """
    ...
    addresses: typing.Optional[typing.List[CreateV2SendersResponseDataAddressesItem]] = pydantic.Field(default=None)
    """
    ...
    kyb: typing.Optional[CreateV2SendersResponseDataKyb] = pydantic.Field(default=None)
    """
    ...
    status: typing.Optional[CreateV2SendersResponseDataStatus] = pydantic.Field(default=None)
    """
    ...
    documents: typing.Optional[typing.List[CreateV2SendersResponseDataDocumentsItem]] = pydantic.Field(default=None)
    """
    ...
    risk_score: typing_extensions.Annotated[
        typing.Optional[CreateV2SendersResponseDataRiskScore],
    ...
    type: typing.Optional[CreateV2SendersResponseDataType] = pydantic.Field(default=None)
    """
    Type of sender
    """

    identity: typing.Optional[CreateV2SendersResponseDataIdentity] = pydantic.Field(default=None)
    """
    ...
    business_type: typing_extensions.Annotated[
        typing.Optional[CreateV2SendersResponseDataBusinessType],
    ...
    tos: typing.Optional[CreateV2SendersResponseDataTos] = pydantic.Field(default=None)
    """
