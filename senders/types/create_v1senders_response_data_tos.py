...
class CreateV1SendersResponseDataTos(UniversalBaseModel):
    """
    Terms of Service status for the sender
    """

    status: typing.Optional[CreateV1SendersResponseDataTosStatus] = pydantic.Field(default=None)
    """
    ...
    link: typing.Optional[CreateV1SendersResponseDataTosLink] = pydantic.Field(default=None)
    """
