...
class CreateV1UbosResponseData(UniversalBaseModel):
    ...
    address: typing.Optional[CreateV1UbosResponseDataAddress] = pydantic.Field(default=None)
    """
    Address information of the UBO
    """

    identity: typing.Optional[CreateV1UbosResponseDataIdentity] = pydantic.Field(default=None)
    """
    ...
    kyc: typing.Optional[CreateV1UbosResponseDataKyc] = pydantic.Field(default=None)
    """
